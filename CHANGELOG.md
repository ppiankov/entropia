...
### Added
- Current Limitations section in README.md (language and format support)
...
### Fixed
- Updated GitHub Actions to Go 1.25 (fixes TLS fingerprinting on aggressive bot-detection sites)
...
### Added
- Troubleshooting section for 403 Forbidden errors in CLI_GUIDE.md

### Fixed
- Error messages now printed to stderr before exit
...
- Updated version references in README.md to v0.1.11
